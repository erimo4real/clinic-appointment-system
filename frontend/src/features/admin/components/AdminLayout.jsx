...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/services', label: 'Services', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  ];
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-900">
          <div className="flex items-center mb-5">
            <Link to="/" className="flex items-center space-x-3">
              ...
              {sidebarOpen && <span className="self-center text-xl font-semibold text-white">MedBook Pro</span>}
            </Link>
          </div>
          ...
          <div className="absolute bottom-4 left-0 w-full px-3">
            <Link
              to="/"
              className="flex items-center p-2 text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
              {sidebarOpen && <span className="ml-3">Back to Website</span>}
            </Link>
          </div>
        </div>
      </aside>
